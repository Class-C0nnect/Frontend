...
@Component({
  selector: 'app-speed-dial-administrador',
  templateUrl: './speed-dial-administrador.component.html',
  styleUrl: './speed-dial-administrador.component.css'
})
export class SpeedDialAdministradorComponent implements OnInit {
  menuOpen = false;
