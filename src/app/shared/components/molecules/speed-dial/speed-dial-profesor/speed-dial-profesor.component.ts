...
@Component({
  selector: 'app-speed-dial-profesor',
  templateUrl: './speed-dial-profesor.component.html',
  styleUrl: './speed-dial-profesor.component.css'
})
export class SpeedDialProfesorComponent implements OnInit {
  menuOpen = false;
